...
import math
import numpy as np
from data.constant import BLANK
...
def getDetBoxes_core(textmap, linkmap, low_text, link_thres, text_thresh):
    ...
    for k in range(1,nLabels):
        ...
        # thresholding
        if np.max(textmap[labels==k]) < text_thresh: continue
